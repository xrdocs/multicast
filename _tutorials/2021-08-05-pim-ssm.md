...
![Screenshot 2021-08-05 at 16.27.52.png]({{site.baseurl}}/{{site.baseurl}}/images/Screenshot 2021-08-05 at 16.27.52.png){: .align-center}
...
![Screenshot 2021-07-14 at 17.39.35.png]({{site.baseurl}}/images/Screenshot 2021-07-14 at 17.39.35.png){: .align-center}
...
debug ip igmp
```
[Youtube: pim ssm configuration video on ncs 5501](https://youtu.be/udYJAxOfJvA)

By enabling debug mode for ip igmp we can check the IGMPv3 joins that are being sent

![Screenshot 2021-08-18 at 13.21.19.png]({{site.baseurl}}/images/Screenshot 2021-08-18 at 13.21.19.png){: .align-center}
